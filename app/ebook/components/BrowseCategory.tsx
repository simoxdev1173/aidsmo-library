...
const BrowseBySubject = () => {
  return (
    <section className="relative overflow-hidden bg-[#F8FAFC] py-16 sm:py-20 md:py-28" dir="rtl">
      <div
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-8 px-4 sm:gap-12 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div className="relative min-h-[34rem] overflow-hidden border border-[#C29C41]/35 bg-[#0A2540] shadow-[0_28px_72px_rgba(10,37,64,0.18)] sm:min-h-[560px]">
          ...
          <div className="relative z-10 flex h-full min-h-[34rem] flex-col justify-between p-5 sm:min-h-[560px] sm:p-8">
            <div className="flex items-center justify-between gap-4 text-white">
              <div>
                <p className="font-display text-xs font-bold uppercase tracking-[0.24em] text-[#E8C96A]">
                  Research Compass
                </p>
                <h2 className="mt-3 text-balance font-academic text-3xl font-bold leading-tight sm:text-4xl md:text-5xl">
            ...
            <div className="research-orbit mx-auto my-8 h-[240px] w-full max-w-[420px] sm:my-10 sm:h-[280px]" aria-hidden>
        ...
        <div>
          ...
          <h2 className="academic-heading mt-4 max-w-2xl text-balance text-3xl leading-tight sm:text-4xl md:text-5xl">
